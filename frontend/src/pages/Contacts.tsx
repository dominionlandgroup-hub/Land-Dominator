      ...
      <div className="p-6">
        ...
        <div className="grid gap-4 mb-6" style={{ gridTemplateColumns: 'repeat(3, 1fr)', maxWidth: '480px' }}>
          {[
            ...
            { label: 'With Phone', value: contacts.filter(c => c.phone).length, accent: '#059669' },
          ].map(s => (
        ...
        {loading ? (
          <div className="flex items-center justify-center py-16">
            <div className="text-sm" style={{ color: '#9B8AAE' }}>Loading contacts…</div>
          </div>
        ) : (
...
function ContactForm({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: 'rgba(26,10,46,0.5)' }}>
      <div className="rounded-lg p-6 w-full" style={{ maxWidth: '520px', maxHeight: '90vh', overflowY: 'auto', background: '#FFFFFF', border: '1px solid #E8E0F0', boxShadow: '0 1px 3px rgba(92,41,119,0.08)' }}>
