  ...
  return (
    <div className="flex flex-col min-h-screen" style={{ background: '#0F0F0F' }}>
      <div className="page-header">
        <div>
          <h1 className="text-lg font-bold" style={{ color: '#F5F5F5' }}>Buyer Inbox</h1>
          <p className="text-xs mt-0.5" style={{ color: '#A0A0A0' }}>Inbound buyer inquiries and messages</p>
        </div>
      </div>
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="text-center max-w-sm">
          ...
          <h2 className="text-lg font-semibold mb-2" style={{ color: '#F5F5F5' }}>Buyer Inbox</h2>
