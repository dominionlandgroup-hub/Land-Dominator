    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          boxShadow: '-8px 0 40px rgba(26,10,46,0.15)',
        }}
      >
        {/* Header */}
        <div className="px-6 pt-6 pb-4" style={{ borderBottom: '1px solid #EDE8F5' }}>
          <div className="flex items-start justify-between mb-3">
            <div>
              <h2 className="text-base font-bold" style={{ color: '#1A0A2E' }}>Setup Guide</h2>
              <p className="text-xs mt-0.5" style={{ color: '#9B8AAE' }}>Complete these steps to launch your first campaign</p>
            </div>
            <button
              onClick={onClose}
              className="w-7 h-7 rounded-lg flex items-center justify-center transition-colors"
              style={{ color: '#9B8AAE', background: 'transparent' }}
          ...
          {completedCount !== null && (
            <div>
              <div className="flex justify-between text-xs mb-1.5" style={{ color: '#6B5B8A' }}>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  border: isNext ? '1px solid rgba(92,41,119,0.2)' : '1px solid #EDE8F5',
                }}
              >
                <div className="flex items-start gap-3">
                  ...
                  <div
                    ...
                    style={{
                      background: done ? '#2D7A4F' : isNext ? '#5C2977' : '#EDE8F5',
                  ...
                  <div className="flex-1 min-w-0">
                    <p
                      ...
                      style={{ color: done ? '#6B5B8A' : '#1A0A2E' }}
                    >
                      {step.label}
                    </p>
                    <p className="text-xs mt-0.5" style={{ color: '#9B8AAE' }}>{step.desc}</p>
                  </div>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: done ? '1px solid #EDE8F5' : isNext ? 'none' : '1px solid #D4B8E8',
                    }}
        ...
        {/* Footer */}
        <div className="px-6 py-4" style={{ borderTop: '1px solid #EDE8F5' }}>
          <p className="text-[10px] text-center" style={{ color: '#C4B8D0' }}>
